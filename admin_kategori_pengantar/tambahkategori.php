...
<head>
  ...
  ?>
    ...
    ?>
    <title><?= $namaAppBaru; ?> | Tambah Kategori</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="<?= $logoapp; ?>" alt="AdminLTELogo">
    </div>
            ...
            <div class="col-lg-6">
              <div class="card card-primary">
                ...
                <form action="prosestambah.php" method="post">
                  <div class="card-body">
                    <a href="../admin_kategori_pengantar" class="btn btn-warning btn-sm"><i class="nav-icon fas fa-chevron-left"></i> Kembali</a>
                    <br>
                    <br>
                    <div class="form-group">
                      <label for="keterangan">Keterangan</label>
                      <input type="text" class="form-control" maxlength="100" id="keterangan" name="keterangan" placeholder="Input Keterangan" required>
                    </div>
                  ...
                  <div class="card-footer">
                    <button type="submit" class="btn btn-primary btn-block" name="tambahkategori"><i class="nav-icon fas fa-plus">&nbsp Tambahkan</i></button>
                  </div>
                </form>
              </div>
              <!-- /.card -->
