...
<head>
  ...
  <?php
  session_start();
  $konstruktor = 'admin_laporan_pengajuan';
            ...
            <div class="col-lg-12">
              <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <a href="ekspor.php" class="btn btn-success btn-sm" target="_blank"><i class="nav-icon fas fa-file-excel"></i> Ekspor</a>
                  <br>
                  <table id="example1" class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                      ...
                      $querypenduduk = mysqli_query($koneksi, "SELECT * FROM tbl_permohonan_surat WHERE status=4 ORDER BY tgl, tgl_acc_rt, tgl_acc_rw, tgl_acc_admin DESC") or die(mysqli_error($koneksi));
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              ...
                              ?>
                              <center>
                                <button class="btn btn-sm btn-success"> <?= $ket; ?>
                                </button>
                              </center>
                            </td>
                            <td>
                              <center>
                                ...
                                <!-- Hapus -->
                                <!-- <a href="proseshapus.php?kd_penduduk=<?= encriptData($dt_surat['nik']) ?>&hapus=hapus" class="btn btn-sm btn-success" onclick="return confirm('Anda akan menghapus data penduduk dengan kode penduduk [<?= $dt_surat['nik']; ?>] - Nama penduduk : [<?= $dt_surat['nama']; ?>]')"><i class="fas fa-check"> </i></a> -->
                                <!-- Eksport -->
                                <a href="eksporpdf.php?nik=<?= encriptData($dt_surat['nik']); ?>&kategori=<?= encriptData($dt_surat['id_kategori_pengantar']); ?>" class="btn btn-danger btn-sm" target="_blank">
...
?>
<!-- Modal Ekspor -->
<div class="modal fade" id="modal-ekspor">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#001f3f;">
        <h4 class="modal-title">
          <font color="#ffffff"><i class="fas fa-file-excel"></i> Ekspor Data Pengajuan</font>
        </h4>
      </div>

      <div class="modal-body">
        <a href="download.php?filename=template_rw.xls" class="btn btn-sm btn-secondary"><i class="nav-icon fas fa-file"></i> Download Template Ekspor Excel</a>
        <form id="modal-ekspor" action="import.php" method="post" enctype="multipart/form-data">
          <div class="col-md-12">
