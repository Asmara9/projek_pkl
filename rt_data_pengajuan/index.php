                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                      ...
                      $querypenduduk = mysqli_query($koneksi, "SELECT * FROM tbl_permohonan_surat WHERE rt='$rt' AND rw='$rw' AND status=1 ORDER BY tgl, tgl_acc_rt, tgl_acc_rw, tgl_acc_admin DESC") or die(mysqli_error($koneksi));
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              ...
                              ?>
                              <center>
                                <button class="btn btn-sm btn-primary"> <?= $ket; ?>
                                </button>
                              </center>
                            </td>
                            <td>
                              <center>
                                ...
                                <!-- ACC -->
                                <a href="proses_acc.php?kd_pengajuan=<?= encriptData($dt_surat['id_permohonan']) ?>&acc=acc" class="btn btn-sm btn-success"><i class="fas fa-check"> </i></a>
                                <!-- Ekspor -->
