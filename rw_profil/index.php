                        ...
                        <div class="col-lg-6">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="nav icon fas fa-user"> &nbsp Profil RW</i></h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="prosestambah.php" method="post">
                                    ...
                                    $queryrt = mysqli_query($koneksi, "SELECT * FROM tbl_rw WHERE nik='$nik'") or die(mysqli_error($koneksi));
                                    if (mysqli_num_rows($queryrt) > 0) {
                                        while ($dt_rw = mysqli_fetch_array($queryrt)) {
                                    ?>
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label for="nik">NIK</label>
                                                    <input type="text" class="form-control" maxlength="20" id="nik" name="nik" placeholder="Input NIK rt" value="<?= $dt_rw['nik']; ?>" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label for="ketua">Nama Ketua RW</label>
                                                    <input type="text" class="form-control" maxlength="100" id="ketua" name="ketua" value="<?= $dt_rw['ketua']; ?>" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label for="rw">Nomor RW</label>
                                                    <input type="text" class="form-control" maxlength="100" id="nama" name="nama" value="<?= $dt_rw['rw']; ?>" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label for="alamat">Alamat</label>
                                                    <input type="text" class="form-control" maxlength="200" id="alamat" name="alamat" value="<?= $dt_rw['alamat']; ?>" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label for="no_hp">NO HP</label>
                                                    <input type="text" class="form-control" maxlength="15" id="no_hp" name="no_hp" value="<?= $dt_rw['kontak']; ?>" disabled>
                                                </div>
