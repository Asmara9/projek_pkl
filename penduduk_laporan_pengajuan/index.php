...
<head>
    ...
    ?>
        ...
        ?>
        <title><?= $namaAppBaru; ?> | Dashboard Laporan Pengajuan</title>
</head>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Master Laporan Pengajuan</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../penduduk_dashboard/">Home</a></li>
                                <li class="breadcrumb-item active">Master Laporan Pengajuan</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <!-- <a href="tambahsurat.php" class="btn btn-primary btn-sm"><i class="nav-icon fas fa-download"></i> Tambah Data</a> -->
                                    <!-- <button type="button" data-toggle="modal" data-target="#modal-import" class="btn btn-sm btn-success"><i class="nav-icon fas fa-file-excel"></i> Ekspor Data</button>
                                    <br> -->
                                    <table id="example1" class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            $querypenduduk = mysqli_query($koneksi, "SELECT * FROM tbl_permohonan_surat WHERE nik='$nik' AND status = 4 ORDER BY tgl, tgl_acc_rt, tgl_acc_rw, tgl_acc_admin DESC") or die(mysqli_error($koneksi));
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            $btnClass = 'btn-success'; // Default warna tombol hijau

                                                            if ($ket == 'Menunggu ACC RT') {
                                                                $btnClass = 'btn-primary';
                                                            } elseif ($ket == 'Menunggu ACC RW') {
                                                                $btnClass = 'btn-warning';
                                                            } elseif ($ket == 'Menunggu ACC Admin') {
                                                                $btnClass = 'btn-info';
                                                            ...
                                                            ?>
                                                            <center>
                                                                <button class="btn btn-sm <?= $btnClass; ?>"> <?= $ket; ?>
                                                                </button>
                                                            </center>
                                                        </td>
                                                        <td>
                                                            <center>
                                                                ...
                                                                <!-- Hapus -->
                                                                <!-- <a href="proseshapus.php?kd_penduduk=<?= encriptData($dt_surat['nik']) ?>&hapus=hapus" class="btn btn-sm btn-success" onclick="return confirm('Anda akan menghapus data penduduk dengan kode penduduk [<?= $dt_surat['nik']; ?>] - Nama penduduk : [<?= $dt_surat['nama']; ?>]')"><i class="fas fa-check"> </i> ACC RW</a> -->
                                                                <!-- Eksport -->
                                                                <a href="eksporpdf.php?nik=<?= encriptData($dt_surat['nik']); ?> &kategori=<?= encriptData($dt_surat['id_kategori_pengantar']); ?>" class="btn btn-sm btn-danger" target="_blank"><i class="fas fa-file-pdf"></i>
                                                                </a>
                                                                <!-- Detail -->
                                            ...
                                            // jika table tidak ada isinya maka
                                                ...
                                                ?>
                                                <tr>
                                                    <td colspan="6">Tidak ditemukan laporan pengajuan pada database</td>
                                                </tr>
                                            <?php
                                            }
