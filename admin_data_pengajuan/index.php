                ...
                <div class="card-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                      ...
                      $querypenduduk = mysqli_query($koneksi, "SELECT * FROM tbl_permohonan_surat WHERE status=3 ORDER BY tgl, tgl_acc_rt, tgl_acc_rw, tgl_acc_admin DESC") or die(mysqli_error($koneksi));
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              ...
                              ?>
                              <center>
                                <button class="btn btn-sm btn-info"> <?= $ket; ?>
                                </button>
                              </center>
                            </td>
                            <td>
