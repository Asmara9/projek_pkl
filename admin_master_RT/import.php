...
<body>
    ...
    if (isset($_POST['imporrt'])) {
        ...
        for ($j = 2; $j <= count($data_excel); $j++) {
            ...
            $cekrw = mysqli_query($koneksi, "SELECT nik FROM tbl_rt WHERE nik='$nik'") or die(mysqli_error($koneksi));
            ...
            if ($rvd > 0) {
                ...
                $tambahrw = mysqli_query($koneksi, "INSERT INTO tbl_rt VALUES ('', '$nik','$rt','$ketua','$kontak','$alamat')") or die(mysqli_error($koneksi));
    ...
    ?>
        ...
        <script>
            swal("Berhasil", "Semua Data RT Berhasil di Import", "success");
