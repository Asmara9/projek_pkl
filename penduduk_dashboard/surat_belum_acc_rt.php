                  ...
                  <button type="button" data-toggle="modal" data-target="#modal-import" class="btn btn-sm btn-success"><i class="nav-icon fas fa-file-excel"></i> Import Data</button> -->
                                    <table id="example1" class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            $querypenduduk = mysqli_query($koneksi, "SELECT * FROM tbl_permohonan_surat WHERE status=1 ORDER BY tgl, tgl_acc_rt, tgl_acc_rw, tgl_acc_admin DESC") or die(mysqli_error($koneksi));
