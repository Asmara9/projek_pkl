...
<head>
  ...
  ?>
    ...
    ?>
    <title><?= $namaAppBaru; ?> | Tambah Data RW</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="<?= $logoapp; ?>" alt="AdminLTELogo" width="200px">
    </div>
            ...
            <div class="col-lg-6">
              <div class="card card-primary">
                ...
                <form action="prosestambah.php" method="post">
                  <div class="card-body">
                    <a href="../admin_master_RW" class="btn btn-warning btn-sm"><i class="nav-icon fas fa-chevron-left"></i> Kembali</a>
                    <br>
                    <br>
                  ...
                  <div class="card-footer">
                    <button type="submit" class="btn btn-primary btn-block" name="tambahrw"><i class="nav-icon fas fa-plus"></i> Tambahkan</button>
                  </div>
                </form>
              </div>
              <!-- /.card -->
