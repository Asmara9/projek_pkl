...
<head>
  ...
  <?php
  session_start();
  $konstruktor = 'rt_laporan_pengajuan';
                ...
                <div class="card-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                      ...
                      $rt_rw = mysqli_query($koneksi, "SELECT rt, rw FROM tbl_rt WHERE nik='$nik'") or die(mysqli_error($koneksi));
                      $arr_rt_rw = mysqli_fetch_assoc($rt_rw);
                      $rt = $arr_rt_rw['rt'];
                      $rw = $arr_rt_rw['rw'];
                      //panggil data pengajuan
                      $querypenduduk = mysqli_query($koneksi, "SELECT * FROM tbl_permohonan_surat WHERE rt='$rt' AND rw='$rw' AND status!=1 ORDER BY tgl DESC") or die(mysqli_error($koneksi));
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              ...
                              <br>
                              Tanggal Selesai - <?= $dt_surat['tgl_acc_rt']; ?>
                            </td>
                            <td>
                              <center>
                                <p><?= $dt_surat['rt'] ?>/<?= $dt_surat['rw'] ?></p>
                              </center>
                            </td>
                            ...
                            <td>
                              <center>
                                ...
                                <!-- ACC -->
                                <!-- <a href="proses_acc.php?kd_penduduk=<?= encriptData($dt_surat['nik']) ?>&acc=acc" class="btn btn-sm btn-success"><i class="fas fa-check"> </i></a> -->
                                <!-- Ekspor -->
                      ...
                      // jika table tidak ada isinya maka
                        ...
                        ?>
                        <tr>
                          <td colspan="8">Tidak ditemukan laporan pengajuan pada database</td>
                        </tr>
                      <?php
                      }
