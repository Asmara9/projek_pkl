                        ...
                        <div class="col-lg-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="nav-icon fas fa-address-card"></i>&nbspDetail Data Pengajuan</h3>
                                </div>

                                <div class="card-body">
                                    <a href="../rt_laporan_pengajuan" class="btn btn-warning btn-sm"><i class="nav-icon fas fa-chevron-left"></i>&nbspKembali</a>
                                    <br>
                                    <br>
                                    <?php
